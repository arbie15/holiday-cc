...
$query = "SELECT username FROM t1 WHERE username = '$username' AND password = '$password';";
...
$username = mysqli_fetch_assoc($query_run);
...
<body>
    ...
    <div class="container">
	<ul><img src="img/logo3.jpg" height="100" width="100" align="left"></ul> 

...
if( isset($_POST['name']) && isset($_POST['roomtype']) && isset($_POST['email']) )

{
	...
	if( !empty($roomtype)  && !empty($name) && !empty($email)  )

	{		
		
			$query1 = "DELETE FROM booking WHERE roomtype='$roomtype' AND name ='$name' AND email='$email'";
			
			//$result = $mysqli->query($query1);
			//echo $result;
			if(mysqli_query($mysqli,$query1))
				{
						echo "<script type='text/javascript'>alert('room booking cancelled successfully');</script>";
